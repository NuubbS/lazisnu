...
class Global_m extends CI_model
{
    ...
    public function view_join_two_unwhere($table1, $table2, $table3, $field, $field1, $order, $ordering, $baris, $dari)
    {
        $this->db->select('*');
        $this->db->from($table1);
        $this->db->join($table2, $table1 . '.' . $field . '=' . $table2 . '.' . $field);
    ...
    public function view_join_two_nolimit($table1, $table2, $table3, $field, $field1, $where)
    {
        $this->db->select('*');
        $this->db->from($table1);
        $this->db->join($table2, $table1 . '.' . $field . '=' . $table2 . '.' . $field);
